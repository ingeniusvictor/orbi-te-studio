...
export function buildTE1PackageReadme(
  ...
  const content = [
    ...
    "",
    "04_Integridad/",
    "  Historial de auditoria del proyecto, ledger persistente del servidor,",
    "  manifest de verificacion server-side e indice SHA-256 del paquete.",
    "",
    ...
    "5. Revise *_TE1_server_audit_ledger.json para la copia independiente",
    "   persistida por el servicio local.",
    "",
    "Windows PowerShell:",
